                        ...
                        <div className="row row-group m-0">
                           <div className="col-12 col-lg-6 col-xl-3 border-light">
                              <div className="card-body">
                                 ...
                                 <p className="text-center mb-0 text-white small-font">Devices<span className="float-right"></span></p>
                              </div>
                           </div>
                           <div className="col-12 col-lg-6 col-xl-3 border-light">
                              <div className="card-body">
                                 ...
                                 <p className="text-center mb-0 text-white small-font">Vulnerable devices<span className="float-right"></span></p>
                              </div>
                           </div>
                           <div className="col-12 col-lg-6 col-xl-3 border-light">
                              <div className="card-body">
                                 ...
                                 <p className="text-center mb-0 text-white small-font">Outdated devices<span className="float-right"></span></p>
                              </div>
                           </div>
                           <div className="col-12 col-lg-6 col-xl-3 border-light">
                              <div className="card-body">
                                 ...
                                 <p className="text-center mb-0 text-white small-font">Discontinued devices<span className="float-right"></span></p>
                              </div>
                           </div>
                        </div>
                     </div>
